<template>
    <div>
        <div class="title"><span>Вопросы</span>
            <span v-if="!showAdd" class="uk-button  uk-button-primary" v-on:click="ShowAddQuestion"
                  uk-icon="plus"></span>
            <span v-if="showAdd" class="uk-button uk-button-default" v-on:click="HideAddQuestion"
                  uk-icon="trash"></span>
        </div>
        <div v-if="showAdd" class="uk-form">
            ...
            <div class="uk-margin">
                <div class="uk-form-controls question-grid " v-for="(item, index) in NewQuestion.answers">
                    <label>
                        <input class="uk-radio" type="radio" name="answers[correct]" :value="index"
                               v-model="NewQuestion.correct"> Ответ №{{index + 1}}
                        <br>
                    ...
                    <div class="input-group">
                        <input type="text" class="uk-input uk-form-width-large" :placeholder="'Ответ №'+(index+1)"
                               v-model="NewQuestion.answers[index].answer" autocomplete="off" required>
                        <textarea class="uk-textarea" placeholder="Description"
                                  v-model="NewQuestion.answers[index].description"></textarea>
                    </div>
                </div>
            </div>
            <div class="uk-margin">
            ...
            <div class="uk-margin">
                <div class="uk-button-group">
                    <span v-on:click="AddQuestion"
                          class="uk-button uk-button-primary"><span>Создать вопрос</span></span>
        ...
        <table class="uk-table uk-table-divider">
            ...
            <tr v-for="item in questions">
                ...
                <td>
                    <ul class="uk-list">
                        <li><span @click="ShowEditQuestion(item.id)" title="Редактировать"
                                  class="uk-button uk-button-small uk-button-primary"><span uk-icon="file-edit"> </span></span>
                        </li>
                        ...
                        <li>
                            <span v-if="!delete_id || delete_id!==item.id" title="Удалить" @click="DeleteShow(item.id)"
                                  class="uk-button uk-button-small uk-button-default">
                                <span uk-icon="trash"></span>
                            </span>
                            <div v-if="delete_id && delete_id===item.id" class="uk-button-group">
                                <span title="Удалить" @click="Delete()"
                                      class="uk-button uk-button-small uk-button-danger">
                                 <span uk-icon="check"></span>
                                </span>
                                    <span title="Удалить" @click="Cancel()"
        ...
        <div class="uk-modal uk-flex-top" uk-modal ref="showEdit">
            ...
            <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
                    ...
                    <div class="mainwrap">
                        <div class="uk-form">
                            <div class="uk-margin">
                                <label class="uk-form-label" for="question">Вопрос:*</label>
                                <div class="uk-form-controls">
                                    <input v-model="editQuestion.question" class="uk-input uk-form-width-large"
                                           type="text" placeholder="Вопрос" autocomplete="off">
                                </div>
                            </div>
                            <div class="uk-margin">
                                <label for="name">Варианты ответа*:</label>
                            ...
                            <div class="uk-margin">
                                <div class="uk-form-controls question-grid "
                                     v-for="(item, index) in editQuestion.answers">
                                    <label>
                                        <input class="uk-radio" type="radio" name="answers[correct]" :value="index"
                                               v-model="editQuestion.correct"> Ответ №{{index + 1}}
                                        <br>
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="uk-input uk-form-width-large"
                                               ...
                                               v-model="editQuestion.answers[index].answer" autocomplete="off" required>
                                        <textarea class="uk-textarea" placeholder="Description"
                                                  v-model="editQuestion.answers[index].description"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="uk-margin">
                                <div class="uk-button-group">
                                    <span v-on:click="editAddAnswer" class="uk-button uk-button-primary"><span
                                        uk-icon="plus"></span></span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" @click="SaveQuestion" class="uk-button uk-button-small uk-button-primary">
                        Сохранить
                    </button>
                    <button type="button" class="uk-button uk-button-small uk-button-danger" @click="HideEditQuestion">
                        Отмена
                    </button>
                </div>
            </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            Delete: function () {
                axios.delete('/admin/test/delete/questions/' + this.delete_id + '/').then(response => {
