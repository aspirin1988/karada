...
<!-- CSRF Token -->
    ...
    @section('styles')
        <link rel="stylesheet" href="/css/profile.css?v=122">
        <link rel="stylesheet" href="/js/owl.carousel.css?v=122">
        <link rel="stylesheet" href="/js/owl.theme.default.min.css?v=122">
    @show
