...
<!-- CSRF Token -->
    ...
    @section('styles')
        <link rel="stylesheet" href="/css/profile.css?v=125">
        <link rel="stylesheet" href="/js/owl.carousel.css?v=125">
        <link rel="stylesheet" href="/js/owl.theme.default.min.css?v=125">
    @show
