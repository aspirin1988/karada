...
<!-- CSRF Token -->
    ...
    @section('styles')
        <link rel="stylesheet" href="/css/profile.css?v=112">
        <link rel="stylesheet" href="/js/owl.carousel.css?v=112">
        <link rel="stylesheet" href="/js/owl.theme.default.min.css?v=112">
    @show
