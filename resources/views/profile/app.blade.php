...
<!-- CSRF Token -->
    ...
    @section('styles')
        <link rel="stylesheet" href="/css/profile.css?v=142">
        <link rel="stylesheet" href="/js/owl.carousel.css?v=142">
        <link rel="stylesheet" href="/js/owl.theme.default.min.css?v=142">
    @show
