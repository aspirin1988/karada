...
<!-- CSRF Token -->
    ...
    @section('styles')
        <link rel="stylesheet" href="/css/profile.css?v=110">
        <link rel="stylesheet" href="/js/owl.carousel.css?v=110">
        <link rel="stylesheet" href="/js/owl.theme.default.min.css?v=110">
    @show
