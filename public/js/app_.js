...
(function () {
  ...
  window.init_over = function () {
    ...
    window.over_list.forEach(function (i) {
      i.addEventListener('mouseover', function () {
        ...
        var img = this.getAttribute('uk-over');
  ...
  window.select_video = function () {
    ...
    window.vidoe_list.forEach(function (i) {
      i.addEventListener('click', function () {
        ...
        var video = this.getAttribute('uk-select-video');
        var title = this.getAttribute('uk-select-title');
        this.classList.add('uk-active');
  ...
  window.addEventListener('load', function () {
    ...
    var next = document.querySelector('.uk-slideshow.uk-auto-play *[uk-slideshow-item="next"]');
    window.init_over();
    window.select_video();
    ...
    promo_code.addEventListener('keyup', function () {
      window.axios.post('/help/get/price', {
...
/***/ 1:
/*!************************************!*\
  !*** multi ./resources/js/app_.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/karada/resources/js/app_.js */"./resources/js/app_.js");
